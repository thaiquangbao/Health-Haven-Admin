...
const ListBenhNhan = ({ dsBenhNhan }) => {
  ...
  const handleDeleteBenhNhan = (id) => {
    ...
    api({
      ...
      sendToken: true,
      path: `/auth/delete/one-patient/${id}`,
    }).then((res) => {
      globalHandler.notify(
        notifyType.SUCCESS,
          ...
          {dsBenhNhan.map((benhnhan, index) => (
            ...
            >
              ...
              <td className="px-6 py-4 flex items-center gap-1">
                <button
                  onClick={() =>
                    adminHandler.showUpdateBenhNhanForm(
                      benhnhan
                    )
                  }
                ...
                <button
                  onClick={() =>
                    handleDeleteBenhNhan(benhnhan._id)
                  }
